...
def handle_packet(pkt):
    if pkt.haslayer(Dot11Deauth):
        ...
        # Try to extract channel from RadioTap or Dot11Elt if available
        channel = pkt.getlayer('Dot11Elt')
        channel_val = str(channel.channel) if channel and hasattr(channel, 'channel') else "Unknown"
